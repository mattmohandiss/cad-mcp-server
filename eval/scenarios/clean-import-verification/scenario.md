...
Are any face tolerances above 0.01mm? Is this import clean and
reliable?

Return JSON: {"is_valid": boolean, "degenerate_edges": number, "free_edges": number, "max_tolerance_below_001": boolean}
